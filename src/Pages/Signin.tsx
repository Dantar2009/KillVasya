...
const Signin = () => {
    ...
    return (
        <RegOrSigninForm title="Вход">
            ...
            <button onClick={() => signIn(loginText, passwordText)} style={{
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 20 }}>
                <button onClick={goRegister} style={{ background: "transparent", color: colors.primary, border: "none", fontSize: 13, cursor: "pointer" }}>Регистрация</button>
